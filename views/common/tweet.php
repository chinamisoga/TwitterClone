<div class="tweet">
    ...
    <div class="content">
        <div class="name">
            <a href="profile.php?user_id=1<?php echo htmlspecialchars($view_tweet['user_id']); ?>">
                <span class="nickname"><?php echo htmlspecialchars($view_tweet['user_nickname']); ?></span>
                <span class="user-name"><?php echo htmlspecialchars($view_tweet['user_name']); ?>・<?php echo $view_tweet['tweet_created_at']; ?></span>
            </a>
        </div>
